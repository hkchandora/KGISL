  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Obx(
          () => controller.isJsonLoaded.isTrue ? SingleChildScrollView(
            child: Form(
